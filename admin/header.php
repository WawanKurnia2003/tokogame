  ...
  <nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php">Wannnnnn Store</a>
      </div>
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          <li class="active">
            <a href="index.php"><span class="glyphicon glyphicon-home"></span> Dashboard <span
                class="sr-only">(current)</span></a>
          </li>
          <li>
            <a href="tampil-barang.php"><span class="glyphicon glyphicon-user"></span>Pesanan Barang</a>
          </li>
          <li>
            <a href="tampil-topup.php"><span class="glyphicon glyphicon-user"></span>Pesanan TopUp</a>
          </li>
          <li>
